...
#define BEAGLEBONE_LCD_AVDD_EN GPIO_TO_PIN(1, 2)
...
static struct pinmux_config lcdc_pin_mux[] = {
	...
	// Added for DVI PDn support
	{"gpmc_ad2.gpmc_ad2",		OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT},
	{NULL, 0},
};
...
static struct pinmux_config mcasp0_pin_mux[] = {
	...
	{"mcasp0_ahclkr.mcasp0_axr2", OMAP_MUX_MODE2 |
...
// Added by Chipsee to support expansion buttons
	...
	{"gpmc_ad3.gpmc_ad3",    OMAP_MUX_MODE7 | AM33XX_PIN_INPUT},
	{NULL, 0},
};
...
static struct pinmux_config boneled_pin_mux[] = {
	...
	{"gpmc_a6.rgmii2_tclk", OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT}, // gpio 22
	{"gpmc_a7.rgmii2_rclk", OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT}, // gpio 23
	{"gpmc_a8.rgmii2_rd3", OMAP_MUX_MODE7 | AM33XX_PIN_OUTPUT}, // gpio 24
	{NULL, 0},
};

static void bone_leds_init(int evm_id, int profile)
{
	int err;
...
static struct evm_dev_cfg beaglebone_dev_cfg[] = {
	...
	{mmc0_init,	DEV_ON_BASEBOARD, PROFILE_NONE},
	{i2c2_init,	DEV_ON_BASEBOARD, PROFILE_NONE},
	{volume_keys_init, DEV_ON_BASEBOARD, PROFILE_NONE},
	{bone_leds_init, DEV_ON_BASEBOARD, PROFILE_NONE},
