...
NaviBar::NaviBar()
        : QGraphicsRectItem()
{
    setRect(0, 0, PAGE_COUNT * ICON_SIZE, ICON_SIZE);
    setPen(Qt::NoPen);
...
//        m_pageAnimator.setFrameRange(0, 500);
...
//	QPushButton *leaveButton = new QPushButton("1111"); 	// use QGraphicsView as parent
	MyMusicTest *w = new MyMusicTest;
//	w->showMaximized();
	w->resize(800, 440);

	m_scene.addWidget(w);
//	m_scene.addWidget(leaveButton);
//	leaveButton->showFullScreen();
